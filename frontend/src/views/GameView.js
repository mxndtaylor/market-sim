                ...
                <Row>
                    ...
                    <Col>
                        <Row>
                            ...
                            <Button className = "buy-button" variant="warning" onClick={() => handleBuyShares(myKey)}><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-piggy-bank" viewBox="0 0 16 16">
