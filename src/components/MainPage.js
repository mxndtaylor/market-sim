        ...
        <Card id = "stockDisplay" name = "stockDisplay">
            ...
            <Card.Body>
                <Row>
                    ...
                    <Col>
                        <Button variant="light" onClick={() => handleSellShares(myKey)}>
...
function formatDate(date) {
  ...
  const StockCard = ({dummyStock, handleSharesChange, myKey, handleBuyShares}) => {
    return (
                ...
                <Row>
                    ...
                    <Col>
                        <Row>
                            ...
                            <Button variant="light" onClick={() => handleBuyShares(myKey)}><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-piggy-bank" viewBox="0 0 16 16">
